...
.social-icons img{
	...
	<body style="padding: 20px;">
		...
		<div class="form-item">
			<div class="css5">
				<?php VLang::__e('DETAIL_3');?>
			</div>
		</div>
		<div class="form-item">
			<div class="css5">
				<?php echo str_replace('{total_value}', $data['order-value'], VLang::__('DETAIL_30'));?>
			</div>
		</div>
		<div class="form-item">
			<div class="css6">
				<?php echo str_replace('{download_url}', v_base_url('order/orderdetails/'.$data['order_id']), VLang::__('DETAIL_5'));?>
			</div>
		</div>
