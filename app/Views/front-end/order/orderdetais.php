...
<script src="<?php echo v_base_url('public/front-end/js/generatePDF.js?time='.time());?>"></script>
<?php
$Currency = new \App\Libraries\Currency();
$AppConfig = new \Config\AppConfig();
?>
<div class="card h-100 thecup-container order-detail">
	<div class="card-body">
		...
		<div class="container text-center">
			...
			<thead>
			  <tr>
				<th><?php VLang::__e('ORDER_DETAILS_PRODUCT');?></th>
			...
			<tr>
				...
				<td>
				<?php echo $productd['price']*$cart->quanlity.' '.get_activities_session()['symbol'];?> <?php 
			...
			<div class="row">
				...
				<div class="container text-center">
				    <div class="row">
						...
						<div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0"><?php echo get_activities_session()['symbol'];?> <?php echo round($totalprice*$Currency->__getExchange(get_activities_session()['currency']), 2);?></div>
					</div>
				</div>
