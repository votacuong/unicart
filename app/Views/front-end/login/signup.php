   ...
   <body>
      <div class="login-form">
	    <div class="logo">
         ...
         <form action="<?php echo v_base_url('user/store');?>" method="post" onSubmit="return checkInfor();">
			<div class="field">
			...
			<div class="field">
               ...
               <input type="text" required="required" placeholder="<?php VLang::__e('SIGN_UP_PHONE');?>" id="phone" name="phone" value="<?php echo $this->data['details']['phone'];?>" >
            ...
            <div class="field">
               ...
               <input type="password" id="password" required="required" placeholder="<?php VLang::__e('SIGN_UP_PASSWORD');?>" name="password" value="" >
            </div>
			<div class="field">
               <div class="fas fa-lock"></div>
               <input type="password" id="confirmpassword" required="required" placeholder="<?php VLang::__e('SIGN_UP_RETYPEPASSWORD');?> " name="retypePassword" value="" >
            </div>
