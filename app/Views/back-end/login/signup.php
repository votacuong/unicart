...
<html lang="en" dir="ltr">
   <head>
      ...
      <title><?php VLang::__e('SIGN_UP_ABBORA');?></title>
      ...
      <div class="login-form">
         ...
         <form action="<?php echo v_base_url('admin/user/doLogin');?>" method="post">
            <div class="field">
               ...
               <input type="email" required="required" placeholder="<?php VLang::__e('SIGN_UP_EMAIL');?>" name="username" value="votacuong2608@gmail.com">
            </div>
            <div class="field">
               <div class="fas fa-lock"></div>
               <input type="password" required="required" placeholder="<?php VLang::__e('SIGN_UP_PASSWORD');?>" name="password" value="123456">
            </div>
